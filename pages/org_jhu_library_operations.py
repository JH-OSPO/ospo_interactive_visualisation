...
st.set_page_config(page_title="jhu-library-operations - OSPO Dashboard", layout="wide", page_icon="📊")

if st.sidebar.button("← Back to Home"):
    st.switch_page("Home.py")

org_name = "jhu-library-operations"
repo_count = 55
...
@st.cache_data
def load_org_data():
    data_path = Path(__file__).resolve().parents[1] / "org_data" / "jhu_library_operations.csv"
...
compliance_data = {
    ...
    "Compliance %": [72.7, 27.3, 0.0, 1.8, 16.4],
}
