...
st.set_page_config(page_title="jhu-data-services - OSPO Dashboard", layout="wide", page_icon="📊")

if st.sidebar.button("← Back to Home"):
    st.switch_page("Home.py")

org_name = "jhu-data-services"
repo_count = 54
...
@st.cache_data
def load_org_data():
    data_path = Path(__file__).resolve().parents[1] / "org_data" / "jhu_data_services.csv"
...
compliance_data = {
    ...
    "Compliance %": [96.3, 64.8, 0.0, 0.0, 1.9],
}
