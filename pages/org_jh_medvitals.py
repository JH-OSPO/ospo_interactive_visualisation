...
st.set_page_config(page_title="JH-MedVitals - OSPO Dashboard", layout="wide", page_icon="📊")

if st.sidebar.button("← Back to Home"):
    st.switch_page("Home.py")

org_name = "JH-MedVitals"
repo_count = 59
...
@st.cache_data
def load_org_data():
    data_path = Path(__file__).resolve().parents[1] / "org_data" / "jh_medvitals.csv"
...
compliance_data = {
    ...
    "Compliance %": [28.8, 0.0, 0.0, 0.0, 10.2],
}
