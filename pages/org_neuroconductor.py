...
st.set_page_config(page_title="neuroconductor - OSPO Dashboard", layout="wide", page_icon="📊")

if st.sidebar.button("← Back to Home"):
    st.switch_page("Home.py")

org_name = "neuroconductor"
repo_count = 94
...
@st.cache_data
def load_org_data():
    data_path = Path(__file__).resolve().parents[1] / "org_data" / "neuroconductor.csv"
...
compliance_data = {
    ...
    "Compliance %": [95.7, 28.7, 1.1, 1.1, 98.9],
}
