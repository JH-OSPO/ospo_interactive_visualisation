...
st.set_page_config(page_title="JHU-CLSP - OSPO Dashboard", layout="wide", page_icon="📊")
...
@st.cache_data
def load_org_data():
    data_path = Path(__file__).resolve().parents[1] / "org_data" / "jhu_clsp.csv"
...
compliance_data = {
    ...
    "Compliance %": [94.1, 23.5, 0.0, 2.0, 0.0],
}
