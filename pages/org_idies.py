...
st.set_page_config(page_title="idies - OSPO Dashboard", layout="wide", page_icon="📊")
...
@st.cache_data
def load_org_data():
    data_path = Path(__file__).resolve().parents[1] / "org_data" / "idies.csv"
...
compliance_data = {
    ...
    "Compliance %": [56.4, 47.3, 0.0, 7.3, 32.7],
}
