...
st.set_page_config(page_title="OHDSI-JHU - OSPO Dashboard", layout="wide", page_icon="📊")
...
@st.cache_data
def load_org_data():
    data_path = Path(__file__).resolve().parents[1] / "org_data" / "ohdsi_jhu.csv"
...
compliance_data = {
    ...
    "Compliance %": [98.1, 26.4, 0.0, 0.0, 0.0],
}
