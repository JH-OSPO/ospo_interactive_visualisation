...
st.set_page_config(page_title="govex - OSPO Dashboard", layout="wide", page_icon="📊")
...
@st.cache_data
def load_org_data():
    data_path = Path(__file__).resolve().parents[1] / "org_data" / "govex.csv"
...
compliance_data = {
    ...
    "Compliance %": [90.1, 25.4, 0.0, 7.0, 2.8],
}
