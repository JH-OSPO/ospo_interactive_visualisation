...
st.set_page_config(page_title="jhu-library-applications - OSPO Dashboard", layout="wide", page_icon="📊")

if st.sidebar.button("← Back to Home"):
    st.switch_page("Home.py")

org_name = "jhu-library-applications"
repo_count = 91
...
@st.cache_data
def load_org_data():
    data_path = Path(__file__).resolve().parents[1] / "org_data" / "jhu_library_applications.csv"
...
compliance_data = {
    ...
    "Compliance %": [89.0, 26.4, 0.0, 0.0, 24.2],
}
